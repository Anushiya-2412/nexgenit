    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div id="studentDetail"></div>
             ...
             <?php include("addAttendance.php");?> <!---add Student popup--->
...
$(document).ready(function () {
  $('#addStudentBtn').click(function () {
   ...
   // Handle change event for customer type
      ...
      success: function(response) {
        ...
        if (response.success) {
          Swal.fire({
            ...
            $('#studentTable').load(location.href + ' #studentTable > *', function() {
