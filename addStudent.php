                        ...
                        <div class="row p-3">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group pb-3">
                                    ...
                                    <input type="tel" pattern="[0-9]{10}" class="form-control" placeholder="Enter Mobile No" name="mobile" id="mobile" required="required">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group pb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group pb-3">
                                    ...
                                    <input type="text" class="form-control" pattern="[0-9]{12}" placeholder="Enter Aadhar Number" name="aadhar" id="aadhar">
                                </div>
                            </div>
                        </div>
                    </div>
